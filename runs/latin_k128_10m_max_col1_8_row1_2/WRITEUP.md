...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 128 | 10000000 | max | 128 | None | 12 | 12 | 1 | 12 | 0.12 | 0.50 | 16 | 64 | 3072 | 393216 | 1888 | 241664 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 128 | 10000000 | max | 80 | 11.706116 | 25.128181 | 13.422064 | 0.239103 | 0.131826 | 0.265917 | 2.008472 |
...
- Best final held-out ensemble loss: 11.706116 at K=128, params=10000000, scheduler=max.
- Certainty consistency: member-certainty ranges averaged by scheduler were {"max": 0.26591668277978897}. Larger ranges indicate that some final sequence members are consistently more certain.
- Ensemble benefit: average individual CE minus ensemble CE averaged by parameter budget was {"10000000": 13.422064316423633}. Positive values mean ensembling improved held-out CE over the average individual member.
- Prediction dissimilarity: mean KL-to-ensemble by scheduler was {"max": 2.008471936364717}. Higher values indicate more diverse member predictions.
